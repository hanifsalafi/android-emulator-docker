...
echo "========================================"
echo "  Restarting Redroid with IP Configuration"
echo "========================================"
echo
...
# Start services
echo "[6/6] Starting Redroid services with IP configuration..."
docker-compose up --build -d

echo
echo "========================================"
echo "  Redroid IP Configuration Complete"
echo "========================================"
echo
...
echo "   - All services use IP: 38.47.180.165"
echo "   - ADB connects to: 38.47.180.165:5555"
echo "   - WebSocket on: 38.47.180.165:3000"
echo "   - Display on: 38.47.180.165:6080"
echo 